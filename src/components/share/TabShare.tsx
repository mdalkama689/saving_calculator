...
const TabShare = () => {
  ...
  const whatsappMessage = encodeURIComponent(
   "I found this useful saving goal calculator tool, check it out: https://seosaurus.in/tools/saving-goal-calculator/"
  );

  const toolUrl = "https://seosaurus.in/tools/saving-goal-calculator/";
